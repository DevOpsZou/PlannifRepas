...
class Recipe(Db):
    ...
    def readRecipe(self, id):
        ...
        FROM recette 
        join recette_ingredients on recette_ingredients.fk_id_recette=id_recette 
        join ingredient on recette_ingredients.fk_id_ingredient = ingredient.id_ingredient
